"""
Django settings for royalestateproject project.
...
SECRET_KEY = 'django-insecure-1d5@!$i&!=7$j2=(pah)+cxse8@iyjh(4czq0-w3ft^%0p=6vj'
...
ROOT_URLCONF = 'royalestateproject.urls'
...
WSGI_APPLICATION = 'royalestateproject.wsgi.application'
